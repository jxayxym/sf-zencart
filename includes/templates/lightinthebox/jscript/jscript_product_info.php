...
$(document).ready(function(){
	...
	var additionalImagesNum = $(".additionalImages").size();
	$(".additionalImages").each(function(i){
		$(this).css({position:'relative'});
		$('<div></div>').text((i+1)+'/'+additionalImagesNum).css({position:'absolute',top:0,left:0,background:'#cc0000',color:'#fff',padding:'5px'}).appendTo(this);
	});
