...
//   } else {
	$content .= zen_draw_input_field('keyword', '', 'id="headerSearchText" size="6" maxlength="60" placeholder="'.HEADER_SEARCH_DEFAULT_TEXT.'" ') . '&nbsp;<input type="submit" value="" class="header_search_submit" />';  
//   }

  $content .= "</form>";
  $content .= '<script type="text/javascript">$(document).ready(function(){ $("#headerSearchText").focus(function(){$("#navMainSearch").addClass("navMainSearchFocus");}).focusout(function(){ $("#navMainSearch").removeClass("navMainSearchFocus"); }); });</script>';
?>