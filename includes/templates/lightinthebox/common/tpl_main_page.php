...
<?php if (DEFINE_BREADCRUMB_STATUS == '1' || (DEFINE_BREADCRUMB_STATUS == '2' && !$this_is_home_page) ) { ?>
    <div id="navBreadCrumb" class="layout_width"><?php echo $breadcrumb->trail(BREAD_CRUMBS_SEPARATOR); ?></div>
<?php } ?>
<!-- eof breadcrumb -->
  
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="contentMainWrapper" class="layout_width">
  <tr>
<?php
