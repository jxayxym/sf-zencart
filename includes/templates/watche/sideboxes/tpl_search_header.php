...
//   } else {
	$content .= zen_draw_input_field('keyword', '', 'id="headerSearchText" size="6" maxlength="30" placeholder="'.HEADER_SEARCH_DEFAULT_TEXT.'" ') . '&nbsp;<input type="submit" value="" class="header_search_submit" />';  
//   }
