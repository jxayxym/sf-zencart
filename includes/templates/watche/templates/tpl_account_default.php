...
?>
  <tr>
    <td width="150px"><?php echo zen_date_short($orders['date_purchased']); ?></td>
    <td width="50px"><?php echo TEXT_NUMBER_SYMBOL . $orders['orders_id']; ?></td>
    <td width="400px"><?php if (getPaymentMethod($orders['orders_id'])=='Shengfu-Paypal Order'&&$orders['orders_status_name']=='Pending') echo $orders['orders_status_name'],'<br />'.'<div style="background:#ffffc0">Please sent your money to this account:<b>'.MODULE_PAYMENT_SHENGFUPAYPAL_ACCOUNT.'</b></div>'; else echo $orders['orders_status_name']; ?></td>
