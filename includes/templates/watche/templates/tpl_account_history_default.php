...
<div class="notice forward"><?php echo TEXT_ORDER_STATUS  ?><?php if (getPaymentMethod($history['orders_id'])=='Shengfu-Paypal Order'&&$history['orders_status_name']=='Pending') echo $history['orders_status_name'],'<br />'.'<div style="background:#ffffc0">Please sent your money <br />to this account:<b>'.MODULE_PAYMENT_SHENGFUPAYPAL_ACCOUNT.'</b></div>'; else echo $history['orders_status_name']; ?></div>
<br class="clearBoth" />
