<div class="navProductsPreviewWrapper">
	...
	<div class="products_preivew_content_wrapper">
		<div id="products_preview_containner">
		<?php echo $content_preview;	?>
		</div>
	</div>
	<div id="products_preview_right" class="back"></div>
	<br class="clearBoth" />	
</div>
...
function page(page){
    ...
    $.ajax({
        ...
        type     : "GET",
        cache    : true,
        data 	 : {'page':page,'action':'products_preview','cPath':'<?php echo isset($_GET['cPath'])?$_GET['cPath']:zen_get_product_path((int)$_GET['products_id']) ?>'},
        dataType : 'json',
        async	 : false,
