...
?>
<div id="footerWrapper" class="layout_site_width">
<div class="centeredContent">
<span id="siteinfoLegal" class="legalCopyright"><?php echo FOOTER_TEXT_BODY; ?><?php include DIR_WS_MODULES.  zen_get_module_directory('analyticstracking.php'); ?></span>
