...
//   } else {
	$content .= zen_draw_input_field('keyword', '', 'id="headerSearchText" size="6" maxlength="30" placeholder="Enter search words here" ') . '&nbsp;<input type="submit" value="" class="header_search_submit" />';  
//   }
