...
<label class="inputLabel" for="telephone"><?php echo 'Telephone:'; ?></label>
<?php echo zen_draw_input_field('telephone', (isset($_GET['edit'])&&is_numeric($_GET['edit']))?zen_get_address_book_telephone($_GET['edit']):'', zen_set_field_length(TABLE_EXT_ADDRESS_BOOK, 'entry_telephone', '32') . ' id="telephone"') . (zen_not_null(ENTRY_TELEPHONE) ? '<span class="alert">' . ENTRY_TELEPHONE . '</span>': ''); ?>
<br class="clearBoth" />
