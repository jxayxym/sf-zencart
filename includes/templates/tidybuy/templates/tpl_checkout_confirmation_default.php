...
<h1 id="checkoutConfirmDefaultHeading"><?php echo _HEADING_TITLE; ?></h1>
...
<?php  } //endif flagAnyOutOfStock ?>
      ...
      <table border="0" width="100%" cellspacing="0" cellpadding="0" id="cartContentsDisplay" class="tabel_style2">
        <tr class="cartTableHeading tableHeading">
        <th scope="col" id="ccQuantityHeading" width="30" class="first_th"><?php echo TABLE_HEADING_QUANTITY; ?></th>
...
?>
          <th scope="col" id="ccTotalHeading" class="last_th"><?php echo TABLE_HEADING_TOTAL; ?></th>
        </tr>
...
<?php
  echo zen_draw_form('checkout_confirmation', $form_action_url, 'post', 'id="checkout_confirmation" onsubmit="submitonce();"'.($_SESSION['payment']=='paypal_agent'?' target="iframe_paypal_agnet"':''));
//   echo zen_draw_form('checkout_confirmation', $form_action_url, 'post', 'id="checkout_confirmation" onsubmit="submitonce();"');
  
  if (is_array($payment_modules->modules)) {
    echo $payment_modules->process_button();
  }
  if($_SESSION['payment']=='paypal_agent'){
  	echo '<iframe name="iframe_paypal_agnet" src="" style="display:none;"></iframe>';
  }
?>
