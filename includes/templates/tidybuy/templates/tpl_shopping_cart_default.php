...
<table  border="0" width="100%" cellspacing="0" cellpadding="0" class="tabel_style2" id="cartContentsDisplay">
     <tr class="tableHeading">
        <th scope="col" id="scQuantityHeading" class="first_th"><?php echo TABLE_HEADING_QUANTITY; ?></th>
        <th scope="col" id="scProductsHeading"><?php echo TABLE_HEADING_PRODUCTS; ?></th>
        <th scope="col" id="scUnitHeading"><?php echo TABLE_HEADING_PRICE; ?></th>
        <th scope="col" id="scTotalHeading"><?php echo TABLE_HEADING_TOTAL; ?></th>
        <th scope="col" id="scRemoveHeading" class="last_th">&nbsp;</th>
     </tr>
...
?>
       ...
       <td class="cartUnitDisplay" valign="middle"><?php echo $product['productsPriceEach']; ?></td>
       <td class="cartTotalDisplay" valign="middle"><?php echo $product['productsPrice']; ?></td>
       <td class="cartRemoveItemDisplay" valign="middle">
<?php
...
?>
<div class="buttonRow back"><?php echo zenCssButton(ICON_IMAGE_UPDATE, ICON_UPDATE_ALT,'submit','button_update'); ?></div>
<?php
