...
<div class="buttonRow forward"><?php echo zen_draw_input_field('login_btn','','class="loginButton" value=""','submit')//echo zen_image_submit(BUTTON_IMAGE_LOGIN, BUTTON_LOGIN_ALT); ?></div>
<div class="buttonRow back important"><?php echo '<a href="' . zen_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></div>
</form>
</div>

<div id="createAccountArea" class="back">
...
<div class="buttonRow forward"><?php echo  zen_draw_input_field('create_account_btn','','class="createAccountButton" value=""','submit');//echo zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div>
</form>
</div>
<!--EOF normal login-->
<?php } ?>
