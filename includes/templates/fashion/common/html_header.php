...
<?php
$directory_array = $template->get_template_part ( $template->get_template_dir ( '.php', DIR_WS_TEMPLATE, $current_page_base, 'css' ), '/^css_/', '.php' );
...
/**
 * custom category handling for a parent and all its children .
 * .. works for any c_XX_XX_children.css where XX_XX is any parent category
 */
