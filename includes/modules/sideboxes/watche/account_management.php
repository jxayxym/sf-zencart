...
'Email Notifications'=>array(
		array('text'=>'Newsletter Subscriptions','link'=>zen_href_link(FILENAME_ACCOUNT_NEWSLETTERS)),
		array('text'=>'Product Notifications','link'=>zen_href_link(FILENAME_ACCOUNT_NOTIFICATIONS)),
	)				
);
