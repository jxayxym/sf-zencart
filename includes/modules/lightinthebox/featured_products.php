...
if ($num_products_count > 0) {
  ...
  if ($featured_products->RecordCount() > 0) {
    if (isset($new_products_category_id) && $new_products_category_id !=0) {
      ...
      $title = '<div class="boxHeading"><h2>' . TABLE_HEADING_FEATURED_PRODUCTS . ($category_title != '' ? ' - ' . $category_title : '') . '</h2></div>';
    } else {
      $title = '<div class="boxHeading"><h2>' . TABLE_HEADING_FEATURED_PRODUCTS . '</h2></div>';
    }
