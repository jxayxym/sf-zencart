	...
	for($i = 0, $n = $num_images; $i < $n; $i ++) {
		...
		if (ZEN_LIGHTBOX_STATUS == 'true') {
			if (ZEN_LIGHTBOX_GALLERY_MODE == 'true') {
				// $rel = 'lightbox-g';
				$rel = "lightbox-g {gallery: \\'gal1\\', smallimage: \\'" . addslashes ( 'image_handle.php?path='.$base_image.'&width='.MEDIUM_IMAGE_WIDTH.'&height='.MEDIUM_IMAGE_HEIGHT ) . "\\',largeimage: \\'" . 'image_handle.php?path='.$products_image_large . "\\'}";
			} else {
				$rel = 'lightbox';
			}
