...
//     if (ACCOUNT_DOB == 'true') $sql_data_array['customers_dob'] = (empty($_POST['dob']) || $dob_entered == '0001-01-01 00:00:00' ? zen_db_prepare_input('0001-01-01 00:00:00') : zen_date_raw($_POST['dob']));
    ...
    $_SESSION['customers_email_address'] = $sql_data_array['customers_email_address'];
...
//       }
//     } else {
      $email_text = sprintf(EMAIL_GREET_NONE, $email_address);
//     }
...
//     $html_msg['EMAIL_LAST_NAME']  = $lastname;
    ...
    if (NEW_SIGNUP_GIFT_VOUCHER_AMOUNT > 0) {
      ...
      $_SESSION['new_signup_coupon_code'] = $coupon_code;
