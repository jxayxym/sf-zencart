...
// page title
define('TITLE', 'toys-and-hobbies.com');
...
// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'Toys and Hobbies on sale at Cheap price, find best Toys and Hobbies at toys-and-hobbies.com now!');
  define('HOME_PAGE_META_KEYWORDS', 'Toys and Hobbies, hobbies, cheap toys');

  // NOTE: If HOME_PAGE_TITLE is left blank (default) then TITLE and SITE_TAGLINE will be used instead.
  define('HOME_PAGE_TITLE', 'Toys and Hobbies'); // usually best left blank
