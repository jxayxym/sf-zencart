...
// page title
define('TITLE', 'watcheonline.co');

// Site Tagline
define('SITE_TAGLINE', 'We can provide the best price and products for you!');

// Custom Keywords
define('CUSTOM_KEYWORDS', '');

// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'We have all kinds of brand watche.');
  define('HOME_PAGE_META_KEYWORDS', '');

  // NOTE: If HOME_PAGE_TITLE is left blank (default) then TITLE and SITE_TAGLINE will be used instead.
  define('HOME_PAGE_TITLE', 'The largest watche shop online.'); // usually best left blank
