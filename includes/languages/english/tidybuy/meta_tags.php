...
// page title
define('TITLE', 'misses-dressy.com');
...
// Home Page Only:
  define('HOME_PAGE_META_DESCRIPTION', 'We can provide high quality dress for you.');
  define('HOME_PAGE_META_KEYWORDS', 'cheap wedding dress,mori lee dress,tarik ediz dress,jovani dress,custom dress');

  // NOTE: If HOME_PAGE_TITLE is left blank (default) then TITLE and SITE_TAGLINE will be used instead.
  define('HOME_PAGE_TITLE', 'mori lee dress | temptation dress | tarik ediz dress | jovani dress | cheap wedding dress | prom dress'); // usually best left blank
