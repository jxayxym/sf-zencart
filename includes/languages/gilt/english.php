...
// END: moved to meta_tags.php
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . STORE_NAME . 'All Rights Reserved');
...
// information box text in sideboxes/information.php
  define('BOX_HEADING_INFORMATION', 'OUR INFO');
...
// information box text in sideboxes/more_information.php - were TUTORIAL_
  ...
  define('BOX_INFORMATION_PAGE_PAY_WIDTHOU_MONEY','<span class="c-red">Pay widthout money!</span>');	
...
// banner_box
  define('BOX_HEADING_BANNER_BOX','Happy new year!');
...
// include template specific meta tags defines
  ...
  define('TEXT_CREATE_ACCOUNT', 'sign up!');
