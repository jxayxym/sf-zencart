...
// recently viewed box text sideboxes/recently_viewed.php  
  define('BOX_HEADING_RECENTLY_VIEWED', '最近浏览的产品');
...
// constants for use in zen_prev_next_display function
  define('TEXT_FILTER_SELECTED','已选择:');
  ...
  define('TEXT_HOVER_OR_CLICK','将鼠标移到图片上查看<br /> 单击图片放大查看');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_HOT_PRODUCTS','热门产品');
  define('TABLE_HEADING_FEATURED_PRODUCTS','推荐商品');

  define('TABLE_HEADING_RELATED_PRODUCTS', '%s个相关样式或颜色的产品');
