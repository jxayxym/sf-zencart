...
// categories box text in sideboxes/categories.php
  define('BOX_HEADING_CATEGORIES', 'Sub Categories');
...
// recently viewed box text sideboxes/recently_viewed.php
...
// javascript messages
  ...
  define('TEXT_FILTER_SELECTED','Your selection:');
  ...
  define('PREVNEXT_BUTTON_PREV', '« Prev Page');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_RELATED_PRODUCTS', 'Available in %s colours / styles');
