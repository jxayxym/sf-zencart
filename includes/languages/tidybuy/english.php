...
// information box text in sideboxes/more_information.php - were TUTORIAL_
  ...
  define('BOX_INFORMATION_PAGE_3', 'Color Chart');
  define('BOX_INFORMATION_PAGE_4', 'Measurement Guide');

//New billing address text
  define('SET_AS_PRIMARY' , 'Set as Primary Address');
  define('NEW_ADDRESS_TITLE', 'Billing Address');
  define('TABLE_HEADING_HOT_PRODUCTS','Hot Products');
...
// javascript messages
  ...
  define('ENTRY_PASSWORD_TEXT', 'Must have at least ' . ENTRY_PASSWORD_MIN_LENGTH . ' characters and more');
  ...
  define('TEXT_HOVER_OR_CLICK','Hover over image to zoom <br /> Click image to enlarge');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_POPULAR_PRODUCTS', 'Popular Products For %s');
...
// Shipping Estimator
  ...
  define('ERROR_SHIPPING_ADDRESS', '<strong>Please fill in your shipping address.</strong> ');
